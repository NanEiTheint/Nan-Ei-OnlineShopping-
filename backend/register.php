            ...
            <div class="p-5">
              ...
              <form action="add_register.php" method="POST" enctype="multipart/form-data" class="user">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="file" name="profile" class="form-control-file form-control-user" id="exampleLastName" placeholder="Choose phpto" accept="image/*">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="exampleInputPhone" placeholder="Phone No." name="phone">
                </div>
                <div class="form-group">
                  <textarea class="form-control form-control-user" id="exampleInputAddress" placeholder="Address" name="address"></textarea>
                </div>
